...
function addPerson(e) {
    ...
    // Pegar os valores dos campos do formulário, o trim() remove espaços em branco no início e no final
...
// Função para exibir ou ocultar o formulário de atualização
function toggleUpdateForm(show) {
    document.getElementById('updateForm').style.display = show ? 'block' : 'none';
}

// Função para exibir a aba desejada (cadastro ou atualização/deleção)
